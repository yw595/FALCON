        ...
        parfor k=1:length(cellLinesArray)
            if ~strcmp(cellLinesArray{k},'MCF7') && ~strcmp(cellLinesArray{k},'K562')
                ...
                elseif strcmp(outputPrefixes{j},'GXFBA')
                    ...
                    initCobraToolbox;
                    modelToRun = nci60ScriptHelper(...
                    origRecon2, outputPrefixes{j}, inputDir, cellLinesArray{k}, INITFilesArray{k}, mCADREFilesArray{k});
                    ...
                    if ~any(strcmp(modelToRun.rxns,'biomass_reaction'))
                        biomassMets = origRecon2.mets(find(origRecon2.S(...
                        1:length(origRecon2.mets),strcmp( origRecon2.rxns,'biomass_reaction' ))~=0));
                        metsList = {}; stoichList = [];
